...
class csSQL extends PDO {
	...
	/**
	 * Class Constructor. This establishes a database connection with PDO.
	 *
	 * Constructor accepts the same arguments with PDO as suggested. Alternatively you can
	...
	public function __construct( $dsn='', $username='', $password='', $driver_options=array() ) {
		...
		if ( ! defined( 'PDO::ATTR_DRIVER_NAME' ) ) {
			$this->error = "csSQL requires PDO extension.";
			exit( $this->error );
		}

		// Check if PHP version is compatible.
		if( version_compare( PHP_VERSION, $this->php_ver, '<') ) {
			$this->error = "csSQL requires PHP version $this->php_ver and higher.";
			exit( $this->error );
		}
	...
	public function debug() {
		...
		echo '<pre>';
		echo 'csSQL - DB Framework - v' . $this->csSQL_ver . "\r\n\r\n";
